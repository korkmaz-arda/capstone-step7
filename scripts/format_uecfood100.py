...
def format_dataset(source_dir, target_dir, train_images, val_images):
...
def split_dataset(source_dir, ratio=0.8):
    class_image_map = {}
...
if __name__ == "__main__":
    ...
    source_dir = f"{ppath}/datasets/UECFOOD100/"
    target_dir = f"{ppath}/datasets/uecfood100-yolo"
    ...
    train_images, val_images = split_dataset(source_dir, ratio=0.8)
    format_dataset(source_dir, target_dir, train_images, val_images)
    print("Done.")
